...
public class NormalAnnotationExprHandler extends BaseHandler {
    ...
    public List<BCEToken> handle(Node node) {
        ...
        switch (parentName){
            ...
            case "ArrayInitializerExpr": tokens.add(new BCEToken("ARRAY_ANNOTATION", node.getClass().getSimpleName())); break;
            case "VariableDeclarationExpr": tokens.add(new BCEToken("VARIABLE_ANNOTATION", node.getClass().getSimpleName())); break;
            case "NormalAnnotationExpr": tokens.add(new BCEToken("ANNOTATION", node.getClass().getSimpleName())); break;
